...
`)+`
`+m);const T=E+p+a,y=E+m+o,b=ql(s,s.VERTEX_SHADER,T),w=ql(s,s.FRAGMENT_SHADER,y);s.attachShader(g,b),s.attachShader(g,w),t.index0AttributeName!==void 0?s.bindAttribLocation(g,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(g,0,"position"),s.linkProgram(g);function R(C){if(i.debug.checkShaderErrors){const N=s.getProgramInfoLog(g)||"",O=s.getShaderInfoLog(b)||"",W=s.getShaderInfoLog(w)||"",k=N.trim(),G=O.trim(),z=W.trim();let j=!0,re=!0;if(s.getProgramParameter(g,s.LINK_STATUS)===!1)if(j=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,g,b,w);else{const ee=jl(s,b,"vertex"),oe=jl(s,w,"fragment");Ge("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(g,s.VALIDATE_STATUS)+`
...
}`,q0=[new D(1,0,0),new D(-1,0,0),new D(0,1,0),new D(0,-1,0),new D(0,0,1),new D(0,0,-1)],Y0=[new D(0,-1,0),new D(0,-1,0),new D(0,0,1),new D(0,0,-1),new D(0,-1,0),new D(0,-1,0)],nc=new ot,cs=new D,va=new D;function j0(i,e,t){let n=new ko;const s=new Re,r=new Re,a=new mt,o=new Jh,u=new Qh,l={},c=t.maxTextureSize,d={[Jn]:Nt,[Nt]:Jn,[Yt]:Yt},f=new bn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Re},radius:{value:4}},vertexShader:W0,fragmentShader:X0}),h=f.clone();h.defines.HORIZONTAL_PASS=1;const _=new at;_.setAttribute("position",new yt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const g=new ze(_,f),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=sr;let m=this.type;this.render=function(w,R,L){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||w.length===0)return;w.type===wu&&(Ae("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),w.type=sr);const v=i.getRenderTarget(),M=i.getActiveCubeFace(),C=i.getActiveMipmapLevel(),N=i.state;N.setBlending(Fn),N.buffers.depth.getReversed()===!0?N.buffers.color.setClear(0,0,0,0):N.buffers.color.setClear(1,1,1,1),N.buffers.depth.setTest(!0),N.setScissorTest(!1);const O=m!==this.type;O&&R.traverse(function(W){W.material&&(Array.isArray(W.material)?W.material.forEach(k=>k.needsUpdate=!0):W.material.needsUpdate=!0)});for(let W=0,k=w.length;W<k;W++){const G=w[W],z=G.shadow;if(z===void 0){Ae("WebGLShadowMap:",G,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;s.copy(z.mapSize);const j=z.getFrameExtents();if(s.multiply(j),r.copy(z.mapSize),(s.x>c||s.y>c)&&(s.x>c&&(r.x=Math.floor(c/j.x),s.x=r.x*j.x,z.mapSize.x=r.x),s.y>c&&(r.y=Math.floor(c/j.y),s.y=r.y*j.y,z.mapSize.y=r.y)),z.map===null||O===!0){if(z.map!==null&&(z.map.depthTexture!==null&&(z.map.depthTexture.dispose(),z.map.depthTexture=null),z.map.dispose()),this.type===us){if(G.isPointLight){Ae("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}z.map=new Sn(s.x,s.y,{format:Wi,type:zn,minFilter:St,magFilter:St,generateMipmaps:!1}),z.map.texture.name=G.name+".shadowMap",z.map.depthTexture=new Es(s.x,s.y,xn),z.map.depthTexture.name=G.name+".shadowMapDepth",z.map.depthTexture.format=kn,z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Dt,z.map.depthTexture.magFilter=Dt}else{G.isPointLight?(z.map=new Gc(s.x),z.map.depthTexture=new Kh(s.x,yn)):(z.map=new Sn(s.x,s.y),z.map.depthTexture=new Es(s.x,s.y,yn)),z.map.depthTexture.name=G.name+".shadowMap",z.map.depthTexture.format=kn;const ee=i.state.buffers.depth.getReversed();this.type===sr?(z.map.depthTexture.compareFunction=ee?Fo:No,z.map.depthTexture.minFilter=St,z.map.depthTexture.magFilter=St):(z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Dt,z.map.depthTexture.magFilter=Dt)}z.camera.updateProjectionMatrix()}const re=z.map.isWebGLCubeRenderTarget?6:1;for(let ee=0;ee<re;ee++){if(z.map.isWebGLCubeRenderTarget)i.setRenderTarget(z.map,ee),i.clear();else{ee===0&&(i.setRenderTarget(z.map),i.clear());const oe=z.getViewport(ee);a.set(r.x*oe.x,r.y*oe.y,r.x*oe.z,r.y*oe.w),N.viewport(a)}if(G.isPointLight){const oe=z.camera,Pe=z.matrix,Ce=G.distance||oe.far;Ce!==oe.far&&(oe.far=Ce,oe.updateProjectionMatrix()),cs.setFromMatrixPosition(G.matrixWorld),oe.position.copy(cs),va.copy(oe.position),va.add(q0[ee]),oe.up.copy(Y0[ee]),oe.lookAt(va),oe.updateMatrixWorld(),Pe.makeTranslation(-cs.x,-cs.y,-cs.z),nc.multiplyMatrices(oe.projectionMatrix,oe.matrixWorldInverse),z._frustum.setFromProjectionMatrix(nc,oe.coordinateSystem,oe.reversedDepth)}else z.updateMatrices(G);n=z.getFrustum(),y(R,L,z.camera,G,this.type)}z.isPointLightShadow!==!0&&this.type===us&&E(z,L),z.needsUpdate=!1}m=this.type,p.needsUpdate=!1,i.setRenderTarget(v,M,C)};function E(w,R){const L=e.update(g);f.defines.VSM_SAMPLES!==w.blurSamples&&(f.defines.VSM_SAMPLES=w.blurSamples,h.defines.VSM_SAMPLES=w.blurSamples,f.needsUpdate=!0,h.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new Sn(s.x,s.y,{format:Wi,type:zn})),f.uniforms.shadow_pass.value=w.map.depthTexture,f.uniforms.resolution.value=w.mapSize,f.uniforms.radius.value=w.radius,i.setRenderTarget(w.mapPass),i.clear(),i.renderBufferDirect(R,null,L,f,g,null),h.uniforms.shadow_pass.value=w.mapPass.texture,h.uniforms.resolution.value=w.mapSize,h.uniforms.radius.value=w.radius,i.setRenderTarget(w.map),i.clear(),i.renderBufferDirect(R,null,L,h,g,null)}function T(w,R,L,v){let M=null;const C=L.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(C!==void 0)M=C;else if(M=L.isPointLight===!0?u:o,i.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const N=M.uuid,O=R.uuid;let W=l[N];W===void 0&&(W={},l[N]=W);let k=W[O];k===void 0&&(k=M.clone(),W[O]=k,R.addEventListener("dispose",b)),M=k}if(M.visible=R.visible,M.wireframe=R.wireframe,v===us?M.side=R.shadowSide!==null?R.shadowSide:R.side:M.side=R.shadowSide!==null?R.shadowSide:d[R.side],M.alphaMap=R.alphaMap,M.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,M.map=R.map,M.clipShadows=R.clipShadows,M.clippingPlanes=R.clippingPlanes,M.clipIntersection=R.clipIntersection,M.displacementMap=R.displacementMap,M.displacementScale=R.displacementScale,M.displacementBias=R.displacementBias,M.wireframeLinewidth=R.wireframeLinewidth,M.linewidth=R.linewidth,L.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const N=i.properties.get(M);N.light=L}return M}function y(w,R,L,v,M){if(w.visible===!1)return;if(w.layers.test(R.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&M===us)&&(!w.frustumCulled||n.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(L.matrixWorldInverse,w.matrixWorld);const O=e.update(w),W=w.material;if(Array.isArray(W)){const k=O.groups;for(let G=0,z=k.length;G<z;G++){const j=k[G],re=W[j.materialIndex];if(re&&re.visible){const ee=T(w,re,v,M);w.onBeforeShadow(i,w,R,L,O,ee,j),i.renderBufferDirect(L,null,O,ee,w,j),w.onAfterShadow(i,w,R,L,O,ee,j)}}}else if(W.visible){const k=T(w,W,v,M);w.onBeforeShadow(i,w,R,L,O,k,null),i.renderBufferDirect(L,null,O,k,w,null),w.onAfterShadow(i,w,R,L,O,k,null)}}const N=w.children;for(let O=0,W=N.length;O<W;O++)y(N[O],R,L,v,M)}function b(w){w.target.removeEventListener("dispose",b);for(const L in l){const v=l[L],M=w.target.uuid;M in v&&(v[M].dispose(),delete v[M])}}}const Z0={[Ra]:Ca,[Pa]:Ia,[Da]:Ua,[Hi]:La,[Ca]:Ra,[Ia]:Pa,[Ua]:Da,[La]:Hi};function K0(i,e){function t(){let I=!1;const he=new mt;let te=null;const fe=new mt(0,0,0,0);return{setMask:function(J){te!==J&&!I&&(i.colorMask(J,J,J,J),te=J)},setLocked:function(J){I=J},setClear:function(J,Z,ne,De,st){st===!0&&(J*=De,Z*=De,ne*=De),he.set(J,Z,ne,De),fe.equals(he)===!1&&(i.clearColor(J,Z,ne,De),fe.copy(he))},reset:function(){I=!1,te=null,fe.set(-1,0,0,0)}}}function n(){let I=!1,he=!1,te=null,fe=null,J=null;return{setReversed:function(Z){if(he!==Z){const ne=e.get("EXT_clip_control");Z?ne.clipControlEXT(ne.LOWER_LEFT_EXT,ne.ZERO_TO_ONE_EXT):ne.clipControlEXT(ne.LOWER_LEFT_EXT,ne.NEGATIVE_ONE_TO_ONE_EXT),he=Z;const De=J;J=null,this.setClear(De)}},getReversed:function(){return he},setTest:function(Z){Z?$(i.DEPTH_TEST):de(i.DEPTH_TEST)},setMask:function(Z){te!==Z&&!I&&(i.depthMask(Z),te=Z)},setFunc:function(Z){if(he&&(Z=Z0[Z]),fe!==Z){switch(Z){case Ra:i.depthFunc(i.NEVER);break;case Ca:i.depthFunc(i.ALWAYS);break;case Pa:i.depthFunc(i.LESS);break;case Hi:i.depthFunc(i.LEQUAL);break;case Da:i.depthFunc(i.EQUAL);break;case La:i.depthFunc(i.GEQUAL);break;case Ia:i.depthFunc(i.GREATER);break;case Ua:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}fe=Z}},setLocked:function(Z){I=Z},setClear:function(Z){J!==Z&&(he&&(Z=1-Z),i.clearDepth(Z),J=Z)},reset:function(){I=!1,te=null,fe=null,J=null,he=!1}}}function s(){let I=!1,he=null,te=null,fe=null,J=null,Z=null,ne=null,De=null,st=null;return{setTest:function(Ze){I||(Ze?$(i.STENCIL_TEST):de(i.STENCIL_TEST))},setMask:function(Ze){he!==Ze&&!I&&(i.stencilMask(Ze),he=Ze)},setFunc:function(Ze,pn,wn){(te!==Ze||fe!==pn||J!==wn)&&(i.stencilFunc(Ze,pn,wn),te=Ze,fe=pn,J=wn)},setOp:function(Ze,pn,wn){(Z!==Ze||ne!==pn||De!==wn)&&(i.stencilOp(Ze,pn,wn),Z=Ze,ne=pn,De=wn)},setLocked:function(Ze){I=Ze},setClear:function(Ze){st!==Ze&&(i.clearStencil(Ze),st=Ze)},reset:function(){I=!1,he=null,te=null,fe=null,J=null,Z=null,ne=null,De=null,st=null}}}const r=new t,a=new n,o=new s,u=new WeakMap,l=new WeakMap;let c={},d={},f=new WeakMap,h=[],_=null,g=!1,p=null,m=null,E=null,T=null,y=null,b=null,w=null,R=new ke(0,0,0),L=0,v=!1,M=null,C=null,N=null,O=null,W=null;const k=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let G=!1,z=0;const j=i.getParameter(i.VERSION);j.indexOf("WebGL")!==-1?(z=parseFloat(/^WebGL (\d)/.exec(j)[1]),G=z>=1):j.indexOf("OpenGL ES")!==-1&&(z=parseFloat(/^OpenGL ES (\d)/.exec(j)[1]),G=z>=2);let re=null,ee={};const oe=i.getParameter(i.SCISSOR_BOX),Pe=i.getParameter(i.VIEWPORT),Ce=new mt().fromArray(oe),lt=new mt().fromArray(Pe);function et(I,he,te,fe){const J=new Uint8Array(4),Z=i.createTexture();i.bindTexture(I,Z),i.texParameteri(I,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(I,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let ne=0;ne<te;ne++)I===i.TEXTURE_3D||I===i.TEXTURE_2D_ARRAY?i.texImage3D(he,0,i.RGBA,1,1,fe,0,i.RGBA,i.UNSIGNED_BYTE,J):i.texImage2D(he+ne,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,J);return Z}const Y={};Y[i.TEXTURE_2D]=et(i.TEXTURE_2D,i.TEXTURE_2D,1),Y[i.TEXTURE_CUBE_MAP]=et(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),Y[i.TEXTURE_2D_ARRAY]=et(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),Y[i.TEXTURE_3D]=et(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),$(i.DEPTH_TEST),a.setFunc(Hi),Ie(!1),ct(Qo),$(i.CULL_FACE),Xe(Fn);function $(I){c[I]!==!0&&(i.enable(I),c[I]=!0)}function de(I){c[I]!==!1&&(i.disable(I),c[I]=!1)}function Le(I,he){return d[I]!==he?(i.bindFramebuffer(I,he),d[I]=he,I===i.DRAW_FRAMEBUFFER&&(d[i.FRAMEBUFFER]=he),I===i.FRAMEBUFFER&&(d[i.DRAW_FRAMEBUFFER]=he),!0):!1}function ge(I,he){let te=h,fe=!1;if(I){te=f.get(he),te===void 0&&(te=[],f.set(he,te));const J=I.textures;if(te.length!==J.length||te[0]!==i.COLOR_ATTACHMENT0){for(let Z=0,ne=J.length;Z<ne;Z++)te[Z]=i.COLOR_ATTACHMENT0+Z;te.length=J.length,fe=!0}}else te[0]!==i.BACK&&(te[0]=i.BACK,fe=!0);fe&&i.drawBuffers(te)}function He(I){return _!==I?(i.useProgram(I),_=I,!0):!1}const gt={[hi]:i.FUNC_ADD,[Cu]:i.FUNC_SUBTRACT,[Pu]:i.FUNC_REVERSE_SUBTRACT};gt[Du]=i.MIN,gt[Lu]=i.MAX;const Ve={[Iu]:i.ZERO,[Uu]:i.ONE,[Nu]:i.SRC_COLOR,[Aa]:i.SRC_ALPHA,[Vu]:i.SRC_ALPHA_SATURATE,[zu]:i.DST_COLOR,[Ou]:i.DST_ALPHA,[Fu]:i.ONE_MINUS_SRC_COLOR,[wa]:i.ONE_MINUS_SRC_ALPHA,[ku]:i.ONE_MINUS_DST_COLOR,[Bu]:i.ONE_MINUS_DST_ALPHA,[Hu]:i.CONSTANT_COLOR,[Gu]:i.ONE_MINUS_CONSTANT_COLOR,[Wu]:i.CONSTANT_ALPHA,[Xu]:i.ONE_MINUS_CONSTANT_ALPHA};function Xe(I,he,te,fe,J,Z,ne,De,st,Ze){if(I===Fn){g===!0&&(de(i.BLEND),g=!1);return}if(g===!1&&($(i.BLEND),g=!0),I!==Ru){if(I!==p||Ze!==v){if((m!==hi||y!==hi)&&(i.blendEquation(i.FUNC_ADD),m=hi,y=hi),Ze)switch(I){case Bi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case sn:i.blendFunc(i.ONE,i.ONE);break;case el:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case tl:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Ge("WebGLState: Invalid blending: ",I);break}else switch(I){case Bi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case sn:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case el:Ge("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case tl:Ge("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ge("WebGLState: Invalid blending: ",I);break}E=null,T=null,b=null,w=null,R.set(0,0,0),L=0,p=I,v=Ze}return}J=J||he,Z=Z||te,ne=ne||fe,(he!==m||J!==y)&&(i.blendEquationSeparate(gt[he],gt[J]),m=he,y=J),(te!==E||fe!==T||Z!==b||ne!==w)&&(i.blendFuncSeparate(Ve[te],Ve[fe],Ve[Z],Ve[ne]),E=te,T=fe,b=Z,w=ne),(De.equals(R)===!1||st!==L)&&(i.blendColor(De.r,De.g,De.b,st),R.copy(De),L=st),p=I,v=!1}function Ye(I,he){I.side===Yt?de(i.CULL_FACE):$(i.CULL_FACE);let te=I.side===Nt;he&&(te=!te),Ie(te),I.blending===Bi&&I.transparent===!1?Xe(Fn):Xe(I.blending,I.blendEquation,I.blendSrc,I.blendDst,I.blendEquationAlpha,I.blendSrcAlpha,I.blendDstAlpha,I.blendColor,I.blendAlpha,I.premultipliedAlpha),a.setFunc(I.depthFunc),a.setTest(I.depthTest),a.setMask(I.depthWrite),r.setMask(I.colorWrite);const fe=I.stencilWrite;o.setTest(fe),fe&&(o.setMask(I.stencilWriteMask),o.setFunc(I.stencilFunc,I.stencilRef,I.stencilFuncMask),o.setOp(I.stencilFail,I.stencilZFail,I.stencilZPass)),xt(I.polygonOffset,I.polygonOffsetFactor,I.polygonOffsetUnits),I.alphaToCoverage===!0?$(i.SAMPLE_ALPHA_TO_COVERAGE):de(i.SAMPLE_ALPHA_TO_COVERAGE)}function Ie(I){M!==I&&(I?i.frontFace(i.CW):i.frontFace(i.CCW),M=I)}function ct(I){I!==Tu?($(i.CULL_FACE),I!==C&&(I===Qo?i.cullFace(i.BACK):I===Au?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):de(i.CULL_FACE),C=I}function P(I){I!==N&&(G&&i.lineWidth(I),N=I)}function xt(I,he,te){I?($(i.POLYGON_OFFSET_FILL),(O!==he||W!==te)&&(i.polygonOffset(he,te),O=he,W=te)):de(i.POLYGON_OFFSET_FILL)}function je(I){I?$(i.SCISSOR_TEST):de(i.SCISSOR_TEST)}function it(I){I===void 0&&(I=i.TEXTURE0+k-1),re!==I&&(i.activeTexture(I),re=I)}function ve(I,he,te){te===void 0&&(re===null?te=i.TEXTURE0+k-1:te=re);let fe=ee[te];fe===void 0&&(fe={type:void 0,texture:void 0},ee[te]=fe),(fe.type!==I||fe.texture!==he)&&(re!==te&&(i.activeTexture(te),re=te),i.bindTexture(I,he||Y[I]),fe.type=I,fe.texture=he)}function A(){const I=ee[re];I!==void 0&&I.type!==void 0&&(i.bindTexture(I.type,null),I.type=void 0,I.texture=void 0)}function x(){try{i.compressedTexImage2D(...arguments)}catch(I){Ge("WebGLState:",I)}}function U(){try{i.compressedTexImage3D(...arguments)}catch(I){Ge("WebGLState:",I)}}function q(){try{i.texSubImage2D(...arguments)}catch(I){Ge("WebGLState:",I)}}function K(){try{i.texSubImage3D(...arguments)}catch(I){Ge("WebGLState:",I)}}function X(){try{i.compressedTexSubImage2D(...arguments)}catch(I){Ge("WebGLState:",I)}}function Se(){try{i.compressedTexSubImage3D(...arguments)}catch(I){Ge("WebGLState:",I)}}function ie(){try{i.texStorage2D(...arguments)}catch(I){Ge("WebGLState:",I)}}function xe(){try{i.texStorage3D(...arguments)}catch(I){Ge("WebGLState:",I)}}function we(){try{i.texImage2D(...arguments)}catch(I){Ge("WebGLState:",I)}}function Q(){try{i.texImage3D(...arguments)}catch(I){Ge("WebGLState:",I)}}function ae(I){Ce.equals(I)===!1&&(i.scissor(I.x,I.y,I.z,I.w),Ce.copy(I))}function _e(I){lt.equals(I)===!1&&(i.viewport(I.x,I.y,I.z,I.w),lt.copy(I))}function Me(I,he){let te=l.get(he);te===void 0&&(te=new WeakMap,l.set(he,te));let fe=te.get(I);fe===void 0&&(fe=i.getUniformBlockIndex(he,I.name),te.set(I,fe))}function se(I,he){const fe=l.get(he).get(I);u.get(he)!==fe&&(i.uniformBlockBinding(he,fe,I.__bindingPointIndex),u.set(he,fe))}function Oe(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),c={},re=null,ee={},d={},f=new WeakMap,h=[],_=null,g=!1,p=null,m=null,E=null,T=null,y=null,b=null,w=null,R=new ke(0,0,0),L=0,v=!1,M=null,C=null,N=null,O=null,W=null,Ce.set(0,0,i.canvas.width,i.canvas.height),lt.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:$,disable:de,bindFramebuffer:Le,drawBuffers:ge,useProgram:He,setBlending:Xe,setMaterial:Ye,setFlipSided:Ie,setCullFace:ct,setLineWidth:P,setPolygonOffset:xt,setScissorTest:je,activeTexture:it,bindTexture:ve,unbindTexture:A,compressedTexImage2D:x,compressedTexImage3D:U,texImage2D:we,texImage3D:Q,updateUBOMapping:Me,uniformBlockBinding:se,texStorage2D:ie,texStorage3D:xe,texSubImage2D:q,texSubImage3D:K,compressedTexSubImage2D:X,compressedTexSubImage3D:Se,scissor:ae,viewport:_e,reset:Oe}}function $0(i,e,t,n,s,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,u=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Re,c=new WeakMap;let d;const f=new WeakMap;let h=!1;try{h=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(A,x){return h?new OffscreenCanvas(A,x):Ms("canvas")}function g(A,x,U){let q=1;const K=ve(A);if((K.width>U||K.height>U)&&(q=U/Math.max(K.width,K.height)),q<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const X=Math.floor(q*K.width),Se=Math.floor(q*K.height);d===void 0&&(d=_(X,Se));const ie=x?_(X,Se):d;return ie.width=X,ie.height=Se,ie.getContext("2d").drawImage(A,0,0,X,Se),Ae("WebGLRenderer: Texture has been resized from ("+K.width+"x"+K.height+") to ("+X+"x"+Se+")."),ie}else return"data"in A&&Ae("WebGLRenderer: Image in DataTexture is too big ("+K.width+"x"+K.height+")."),A;return A}function p(A){return A.generateMipmaps}function m(A){i.generateMipmap(A)}function E(A){return A.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?i.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function T(A,x,U,q,K=!1){if(A!==null){if(i[A]!==void 0)return i[A];Ae("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let X=x;if(x===i.RED&&(U===i.FLOAT&&(X=i.R32F),U===i.HALF_FLOAT&&(X=i.R16F),U===i.UNSIGNED_BYTE&&(X=i.R8)),x===i.RED_INTEGER&&(U===i.UNSIGNED_BYTE&&(X=i.R8UI),U===i.UNSIGNED_SHORT&&(X=i.R16UI),U===i.UNSIGNED_INT&&(X=i.R32UI),U===i.BYTE&&(X=i.R8I),U===i.SHORT&&(X=i.R16I),U===i.INT&&(X=i.R32I)),x===i.RG&&(U===i.FLOAT&&(X=i.RG32F),U===i.HALF_FLOAT&&(X=i.RG16F),U===i.UNSIGNED_BYTE&&(X=i.RG8)),x===i.RG_INTEGER&&(U===i.UNSIGNED_BYTE&&(X=i.RG8UI),U===i.UNSIGNED_SHORT&&(X=i.RG16UI),U===i.UNSIGNED_INT&&(X=i.RG32UI),U===i.BYTE&&(X=i.RG8I),U===i.SHORT&&(X=i.RG16I),U===i.INT&&(X=i.RG32I)),x===i.RGB_INTEGER&&(U===i.UNSIGNED_BYTE&&(X=i.RGB8UI),U===i.UNSIGNED_SHORT&&(X=i.RGB16UI),U===i.UNSIGNED_INT&&(X=i.RGB32UI),U===i.BYTE&&(X=i.RGB8I),U===i.SHORT&&(X=i.RGB16I),U===i.INT&&(X=i.RGB32I)),x===i.RGBA_INTEGER&&(U===i.UNSIGNED_BYTE&&(X=i.RGBA8UI),U===i.UNSIGNED_SHORT&&(X=i.RGBA16UI),U===i.UNSIGNED_INT&&(X=i.RGBA32UI),U===i.BYTE&&(X=i.RGBA8I),U===i.SHORT&&(X=i.RGBA16I),U===i.INT&&(X=i.RGBA32I)),x===i.RGB&&(U===i.UNSIGNED_INT_5_9_9_9_REV&&(X=i.RGB9_E5),U===i.UNSIGNED_INT_10F_11F_11F_REV&&(X=i.R11F_G11F_B10F)),x===i.RGBA){const Se=K?yr:We.getTransfer(q);U===i.FLOAT&&(X=i.RGBA32F),U===i.HALF_FLOAT&&(X=i.RGBA16F),U===i.UNSIGNED_BYTE&&(X=Se===$e?i.SRGB8_ALPHA8:i.RGBA8),U===i.UNSIGNED_SHORT_4_4_4_4&&(X=i.RGBA4),U===i.UNSIGNED_SHORT_5_5_5_1&&(X=i.RGB5_A1)}return(X===i.R16F||X===i.R32F||X===i.RG16F||X===i.RG32F||X===i.RGBA16F||X===i.RGBA32F)&&e.get("EXT_color_buffer_float"),X}function y(A,x){let U;return A?x===null||x===yn||x===vs?U=i.DEPTH24_STENCIL8:x===xn?U=i.DEPTH32F_STENCIL8:x===xs&&(U=i.DEPTH24_STENCIL8,Ae("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===yn||x===vs?U=i.DEPTH_COMPONENT24:x===xn?U=i.DEPTH_COMPONENT32F:x===xs&&(U=i.DEPTH_COMPONENT16),U}function b(A,x){return p(A)===!0||A.isFramebufferTexture&&A.minFilter!==Dt&&A.minFilter!==St?Math.log2(Math.max(x.width,x.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?x.mipmaps.length:1}function w(A){const x=A.target;x.removeEventListener("dispose",w),L(x),x.isVideoTexture&&c.delete(x)}function R(A){const x=A.target;x.removeEventListener("dispose",R),M(x)}function L(A){const x=n.get(A);if(x.__webglInit===void 0)return;const U=A.source,q=f.get(U);if(q){const K=q[x.__cacheKey];K.usedTimes--,K.usedTimes===0&&v(A),Object.keys(q).length===0&&f.delete(U)}n.remove(A)}function v(A){const x=n.get(A);i.deleteTexture(x.__webglTexture);const U=A.source,q=f.get(U);delete q[x.__cacheKey],a.memory.textures--}function M(A){const x=n.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),n.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let q=0;q<6;q++){if(Array.isArray(x.__webglFramebuffer[q]))for(let K=0;K<x.__webglFramebuffer[q].length;K++)i.deleteFramebuffer(x.__webglFramebuffer[q][K]);else i.deleteFramebuffer(x.__webglFramebuffer[q]);x.__webglDepthbuffer&&i.deleteRenderbuffer(x.__webglDepthbuffer[q])}else{if(Array.isArray(x.__webglFramebuffer))for(let q=0;q<x.__webglFramebuffer.length;q++)i.deleteFramebuffer(x.__webglFramebuffer[q]);else i.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&i.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&i.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let q=0;q<x.__webglColorRenderbuffer.length;q++)x.__webglColorRenderbuffer[q]&&i.deleteRenderbuffer(x.__webglColorRenderbuffer[q]);x.__webglDepthRenderbuffer&&i.deleteRenderbuffer(x.__webglDepthRenderbuffer)}const U=A.textures;for(let q=0,K=U.length;q<K;q++){const X=n.get(U[q]);X.__webglTexture&&(i.deleteTexture(X.__webglTexture),a.memory.textures--),n.remove(U[q])}n.remove(A)}let C=0;function N(){C=0}function O(){const A=C;return A>=s.maxTextures&&Ae("WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+s.maxTextures),C+=1,A}function W(A){const x=[];return x.push(A.wrapS),x.push(A.wrapT),x.push(A.wrapR||0),x.push(A.magFilter),x.push(A.minFilter),x.push(A.anisotropy),x.push(A.internalFormat),x.push(A.format),x.push(A.type),x.push(A.generateMipmaps),x.push(A.premultiplyAlpha),x.push(A.flipY),x.push(A.unpackAlignment),x.push(A.colorSpace),x.join()}function k(A,x){const U=n.get(A);if(A.isVideoTexture&&je(A),A.isRenderTargetTexture===!1&&A.isExternalTexture!==!0&&A.version>0&&U.__version!==A.version){const q=A.image;if(q===null)Ae("WebGLRenderer: Texture marked for update but no image data found.");else if(q.complete===!1)Ae("WebGLRenderer: Texture marked for update but image is incomplete");else{Y(U,A,x);return}}else A.isExternalTexture&&(U.__webglTexture=A.sourceTexture?A.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,U.__webglTexture,i.TEXTURE0+x)}function G(A,x){const U=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&U.__version!==A.version){Y(U,A,x);return}else A.isExternalTexture&&(U.__webglTexture=A.sourceTexture?A.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,U.__webglTexture,i.TEXTURE0+x)}function z(A,x){const U=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&U.__version!==A.version){Y(U,A,x);return}t.bindTexture(i.TEXTURE_3D,U.__webglTexture,i.TEXTURE0+x)}function j(A,x){const U=n.get(A);if(A.isCubeDepthTexture!==!0&&A.version>0&&U.__version!==A.version){$(U,A,x);return}t.bindTexture(i.TEXTURE_CUBE_MAP,U.__webglTexture,i.TEXTURE0+x)}const re={[Nn]:i.REPEAT,[_n]:i.CLAMP_TO_EDGE,[Oa]:i.MIRRORED_REPEAT},ee={[Dt]:i.NEAREST,[ju]:i.NEAREST_MIPMAP_NEAREST,[Ds]:i.NEAREST_MIPMAP_LINEAR,[St]:i.LINEAR,[zr]:i.LINEAR_MIPMAP_NEAREST,[Zn]:i.LINEAR_MIPMAP_LINEAR},oe={[$u]:i.NEVER,[nh]:i.ALWAYS,[Ju]:i.LESS,[No]:i.LEQUAL,[Qu]:i.EQUAL,[Fo]:i.GEQUAL,[eh]:i.GREATER,[th]:i.NOTEQUAL};function Pe(A,x){if(x.type===xn&&e.has("OES_texture_float_linear")===!1&&(x.magFilter===St||x.magFilter===zr||x.magFilter===Ds||x.magFilter===Zn||x.minFilter===St||x.minFilter===zr||x.minFilter===Ds||x.minFilter===Zn)&&Ae("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(A,i.TEXTURE_WRAP_S,re[x.wrapS]),i.texParameteri(A,i.TEXTURE_WRAP_T,re[x.wrapT]),(A===i.TEXTURE_3D||A===i.TEXTURE_2D_ARRAY)&&i.texParameteri(A,i.TEXTURE_WRAP_R,re[x.wrapR]),i.texParameteri(A,i.TEXTURE_MAG_FILTER,ee[x.magFilter]),i.texParameteri(A,i.TEXTURE_MIN_FILTER,ee[x.minFilter]),x.compareFunction&&(i.texParameteri(A,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(A,i.TEXTURE_COMPARE_FUNC,oe[x.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===Dt||x.minFilter!==Ds&&x.minFilter!==Zn||x.type===xn&&e.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||n.get(x).__currentAnisotropy){const U=e.get("EXT_texture_filter_anisotropic");i.texParameterf(A,U.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,s.getMaxAnisotropy())),n.get(x).__currentAnisotropy=x.anisotropy}}}function Ce(A,x){let U=!1;A.__webglInit===void 0&&(A.__webglInit=!0,x.addEventListener("dispose",w));const q=x.source;let K=f.get(q);K===void 0&&(K={},f.set(q,K));const X=W(x);if(X!==A.__cacheKey){K[X]===void 0&&(K[X]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,U=!0),K[X].usedTimes++;const Se=K[A.__cacheKey];Se!==void 0&&(K[A.__cacheKey].usedTimes--,Se.usedTimes===0&&v(x)),A.__cacheKey=X,A.__webglTexture=K[X].texture}return U}function lt(A,x,U){return Math.floor(Math.floor(A/U)/x)}function et(A,x,U,q){const X=A.updateRanges;if(X.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,x.width,x.height,U,q,x.data);else{X.sort((Q,ae)=>Q.start-ae.start);let Se=0;for(let Q=1;Q<X.length;Q++){const ae=X[Se],_e=X[Q],Me=ae.start+ae.count,se=lt(_e.start,x.width,4),Oe=lt(ae.start,x.width,4);_e.start<=Me+1&&se===Oe&&lt(_e.start+_e.count-1,x.width,4)===se?ae.count=Math.max(ae.count,_e.start+_e.count-ae.start):(++Se,X[Se]=_e)}X.length=Se+1;const ie=i.getParameter(i.UNPACK_ROW_LENGTH),xe=i.getParameter(i.UNPACK_SKIP_PIXELS),we=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,x.width);for(let Q=0,ae=X.length;Q<ae;Q++){const _e=X[Q],Me=Math.floor(_e.start/4),se=Math.ceil(_e.count/4),Oe=Me%x.width,I=Math.floor(Me/x.width),he=se,te=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,Oe),i.pixelStorei(i.UNPACK_SKIP_ROWS,I),t.texSubImage2D(i.TEXTURE_2D,0,Oe,I,he,te,U,q,x.data)}A.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,ie),i.pixelStorei(i.UNPACK_SKIP_PIXELS,xe),i.pixelStorei(i.UNPACK_SKIP_ROWS,we)}}function Y(A,x,U){let q=i.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(q=i.TEXTURE_2D_ARRAY),x.isData3DTexture&&(q=i.TEXTURE_3D);const K=Ce(A,x),X=x.source;t.bindTexture(q,A.__webglTexture,i.TEXTURE0+U);const Se=n.get(X);if(X.version!==Se.__version||K===!0){t.activeTexture(i.TEXTURE0+U);const ie=We.getPrimaries(We.workingColorSpace),xe=x.colorSpace===jn?null:We.getPrimaries(x.colorSpace),we=x.colorSpace===jn||ie===xe?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,we);let Q=g(x.image,!1,s.maxTextureSize);Q=it(x,Q);const ae=r.convert(x.format,x.colorSpace),_e=r.convert(x.type);let Me=T(x.internalFormat,ae,_e,x.colorSpace,x.isVideoTexture);Pe(q,x);let se;const Oe=x.mipmaps,I=x.isVideoTexture!==!0,he=Se.__version===void 0||K===!0,te=X.dataReady,fe=b(x,Q);if(x.isDepthTexture)Me=y(x.format===fi,x.type),he&&(I?t.texStorage2D(i.TEXTURE_2D,1,Me,Q.width,Q.height):t.texImage2D(i.TEXTURE_2D,0,Me,Q.width,Q.height,0,ae,_e,null));else if(x.isDataTexture)if(Oe.length>0){I&&he&&t.texStorage2D(i.TEXTURE_2D,fe,Me,Oe[0].width,Oe[0].height);for(let J=0,Z=Oe.length;J<Z;J++)se=Oe[J],I?te&&t.texSubImage2D(i.TEXTURE_2D,J,0,0,se.width,se.height,ae,_e,se.data):t.texImage2D(i.TEXTURE_2D,J,Me,se.width,se.height,0,ae,_e,se.data);x.generateMipmaps=!1}else I?(he&&t.texStorage2D(i.TEXTURE_2D,fe,Me,Q.width,Q.height),te&&et(x,Q,ae,_e)):t.texImage2D(i.TEXTURE_2D,0,Me,Q.width,Q.height,0,ae,_e,Q.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){I&&he&&t.texStorage3D(i.TEXTURE_2D_ARRAY,fe,Me,Oe[0].width,Oe[0].height,Q.depth);for(let J=0,Z=Oe.length;J<Z;J++)if(se=Oe[J],x.format!==hn)if(ae!==null)if(I){if(te)if(x.layerUpdates.size>0){const ne=Il(se.width,se.height,x.format,x.type);for(const De of x.layerUpdates){const st=se.data.subarray(De*ne/se.data.BYTES_PER_ELEMENT,(De+1)*ne/se.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,De,se.width,se.height,1,ae,st)}x.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,0,se.width,se.height,Q.depth,ae,se.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,J,Me,se.width,se.height,Q.depth,0,se.data,0,0);else Ae("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else I?te&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,0,se.width,se.height,Q.depth,ae,_e,se.data):t.texImage3D(i.TEXTURE_2D_ARRAY,J,Me,se.width,se.height,Q.depth,0,ae,_e,se.data)}else{I&&he&&t.texStorage2D(i.TEXTURE_2D,fe,Me,Oe[0].width,Oe[0].height);for(let J=0,Z=Oe.length;J<Z;J++)se=Oe[J],x.format!==hn?ae!==null?I?te&&t.compressedTexSubImage2D(i.TEXTURE_2D,J,0,0,se.width,se.height,ae,se.data):t.compressedTexImage2D(i.TEXTURE_2D,J,Me,se.width,se.height,0,se.data):Ae("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):I?te&&t.texSubImage2D(i.TEXTURE_2D,J,0,0,se.width,se.height,ae,_e,se.data):t.texImage2D(i.TEXTURE_2D,J,Me,se.width,se.height,0,ae,_e,se.data)}else if(x.isDataArrayTexture)if(I){if(he&&t.texStorage3D(i.TEXTURE_2D_ARRAY,fe,Me,Q.width,Q.height,Q.depth),te)if(x.layerUpdates.size>0){const J=Il(Q.width,Q.height,x.format,x.type);for(const Z of x.layerUpdates){const ne=Q.data.subarray(Z*J/Q.data.BYTES_PER_ELEMENT,(Z+1)*J/Q.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,Z,Q.width,Q.height,1,ae,_e,ne)}x.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,ae,_e,Q.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Me,Q.width,Q.height,Q.depth,0,ae,_e,Q.data);else if(x.isData3DTexture)I?(he&&t.texStorage3D(i.TEXTURE_3D,fe,Me,Q.width,Q.height,Q.depth),te&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,ae,_e,Q.data)):t.texImage3D(i.TEXTURE_3D,0,Me,Q.width,Q.height,Q.depth,0,ae,_e,Q.data);else if(x.isFramebufferTexture){if(he)if(I)t.texStorage2D(i.TEXTURE_2D,fe,Me,Q.width,Q.height);else{let J=Q.width,Z=Q.height;for(let ne=0;ne<fe;ne++)t.texImage2D(i.TEXTURE_2D,ne,Me,J,Z,0,ae,_e,null),J>>=1,Z>>=1}}else if(Oe.length>0){if(I&&he){const J=ve(Oe[0]);t.texStorage2D(i.TEXTURE_2D,fe,Me,J.width,J.height)}for(let J=0,Z=Oe.length;J<Z;J++)se=Oe[J],I?te&&t.texSubImage2D(i.TEXTURE_2D,J,0,0,ae,_e,se):t.texImage2D(i.TEXTURE_2D,J,Me,ae,_e,se);x.generateMipmaps=!1}else if(I){if(he){const J=ve(Q);t.texStorage2D(i.TEXTURE_2D,fe,Me,J.width,J.height)}te&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ae,_e,Q)}else t.texImage2D(i.TEXTURE_2D,0,Me,ae,_e,Q);p(x)&&m(q),Se.__version=X.version,x.onUpdate&&x.onUpdate(x)}A.__version=x.version}function $(A,x,U){if(x.image.length!==6)return;const q=Ce(A,x),K=x.source;t.bindTexture(i.TEXTURE_CUBE_MAP,A.__webglTexture,i.TEXTURE0+U);const X=n.get(K);if(K.version!==X.__version||q===!0){t.activeTexture(i.TEXTURE0+U);const Se=We.getPrimaries(We.workingColorSpace),ie=x.colorSpace===jn?null:We.getPrimaries(x.colorSpace),xe=x.colorSpace===jn||Se===ie?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,xe);const we=x.isCompressedTexture||x.image[0].isCompressedTexture,Q=x.image[0]&&x.image[0].isDataTexture,ae=[];for(let Z=0;Z<6;Z++)!we&&!Q?ae[Z]=g(x.image[Z],!0,s.maxCubemapSize):ae[Z]=Q?x.image[Z].image:x.image[Z],ae[Z]=it(x,ae[Z]);const _e=ae[0],Me=r.convert(x.format,x.colorSpace),se=r.convert(x.type),Oe=T(x.internalFormat,Me,se,x.colorSpace),I=x.isVideoTexture!==!0,he=X.__version===void 0||q===!0,te=K.dataReady;let fe=b(x,_e);Pe(i.TEXTURE_CUBE_MAP,x);let J;if(we){I&&he&&t.texStorage2D(i.TEXTURE_CUBE_MAP,fe,Oe,_e.width,_e.height);for(let Z=0;Z<6;Z++){J=ae[Z].mipmaps;for(let ne=0;ne<J.length;ne++){const De=J[ne];x.format!==hn?Me!==null?I?te&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ne,0,0,De.width,De.height,Me,De.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ne,Oe,De.width,De.height,0,De.data):Ae("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):I?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ne,0,0,De.width,De.height,Me,se,De.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ne,Oe,De.width,De.height,0,Me,se,De.data)}}}else{if(J=x.mipmaps,I&&he){J.length>0&&fe++;const Z=ve(ae[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,fe,Oe,Z.width,Z.height)}for(let Z=0;Z<6;Z++)if(Q){I?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,ae[Z].width,ae[Z].height,Me,se,ae[Z].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,Oe,ae[Z].width,ae[Z].height,0,Me,se,ae[Z].data);for(let ne=0;ne<J.length;ne++){const st=J[ne].image[Z].image;I?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ne+1,0,0,st.width,st.height,Me,se,st.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ne+1,Oe,st.width,st.height,0,Me,se,st.data)}}else{I?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,Me,se,ae[Z]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,Oe,Me,se,ae[Z]);for(let ne=0;ne<J.length;ne++){const De=J[ne];I?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ne+1,0,0,Me,se,De.image[Z]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ne+1,Oe,Me,se,De.image[Z])}}}p(x)&&m(i.TEXTURE_CUBE_MAP),X.__version=K.version,x.onUpdate&&x.onUpdate(x)}A.__version=x.version}function de(A,x,U,q,K,X){const Se=r.convert(U.format,U.colorSpace),ie=r.convert(U.type),xe=T(U.internalFormat,Se,ie,U.colorSpace),we=n.get(x),Q=n.get(U);if(Q.__renderTarget=x,!we.__hasExternalTextures){const ae=Math.max(1,x.width>>X),_e=Math.max(1,x.height>>X);K===i.TEXTURE_3D||K===i.TEXTURE_2D_ARRAY?t.texImage3D(K,X,xe,ae,_e,x.depth,0,Se,ie,null):t.texImage2D(K,X,xe,ae,_e,0,Se,ie,null)}t.bindFramebuffer(i.FRAMEBUFFER,A),xt(x)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,q,K,Q.__webglTexture,0,P(x)):(K===i.TEXTURE_2D||K>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&K<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,q,K,Q.__webglTexture,X),t.bindFramebuffer(i.FRAMEBUFFER,null)}function Le(A,x,U){if(i.bindRenderbuffer(i.RENDERBUFFER,A),x.depthBuffer){const q=x.depthTexture,K=q&&q.isDepthTexture?q.type:null,X=y(x.stencilBuffer,K),Se=x.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;xt(x)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,P(x),X,x.width,x.height):U?i.renderbufferStorageMultisample(i.RENDERBUFFER,P(x),X,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,X,x.width,x.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Se,i.RENDERBUFFER,A)}else{const q=x.textures;for(let K=0;K<q.length;K++){const X=q[K],Se=r.convert(X.format,X.colorSpace),ie=r.convert(X.type),xe=T(X.internalFormat,Se,ie,X.colorSpace);xt(x)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,P(x),xe,x.width,x.height):U?i.renderbufferStorageMultisample(i.RENDERBUFFER,P(x),xe,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,xe,x.width,x.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function ge(A,x,U){const q=x.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,A),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const K=n.get(x.depthTexture);if(K.__renderTarget=x,(!K.__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),q){if(K.__webglInit===void 0&&(K.__webglInit=!0,x.depthTexture.addEventListener("dispose",w)),K.__webglTexture===void 0){K.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,K.__webglTexture),Pe(i.TEXTURE_CUBE_MAP,x.depthTexture);const we=r.convert(x.depthTexture.format),Q=r.convert(x.depthTexture.type);let ae;x.depthTexture.format===kn?ae=i.DEPTH_COMPONENT24:x.depthTexture.format===fi&&(ae=i.DEPTH24_STENCIL8);for(let _e=0;_e<6;_e++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_e,0,ae,x.width,x.height,0,we,Q,null)}}else k(x.depthTexture,0);const X=K.__webglTexture,Se=P(x),ie=q?i.TEXTURE_CUBE_MAP_POSITIVE_X+U:i.TEXTURE_2D,xe=x.depthTexture.format===fi?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(x.depthTexture.format===kn)xt(x)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,xe,ie,X,0,Se):i.framebufferTexture2D(i.FRAMEBUFFER,xe,ie,X,0);else if(x.depthTexture.format===fi)xt(x)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,xe,ie,X,0,Se):i.framebufferTexture2D(i.FRAMEBUFFER,xe,ie,X,0);else throw new Error("Unknown depthTexture format")}function He(A){const x=n.get(A),U=A.isWebGLCubeRenderTarget===!0;if(x.__boundDepthTexture!==A.depthTexture){const q=A.depthTexture;if(x.__depthDisposeCallback&&x.__depthDisposeCallback(),q){const K=()=>{delete x.__boundDepthTexture,delete x.__depthDisposeCallback,q.removeEventListener("dispose",K)};q.addEventListener("dispose",K),x.__depthDisposeCallback=K}x.__boundDepthTexture=q}if(A.depthTexture&&!x.__autoAllocateDepthBuffer)if(U)for(let q=0;q<6;q++)ge(x.__webglFramebuffer[q],A,q);else{const q=A.texture.mipmaps;q&&q.length>0?ge(x.__webglFramebuffer[0],A,0):ge(x.__webglFramebuffer,A,0)}else if(U){x.__webglDepthbuffer=[];for(let q=0;q<6;q++)if(t.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer[q]),x.__webglDepthbuffer[q]===void 0)x.__webglDepthbuffer[q]=i.createRenderbuffer(),Le(x.__webglDepthbuffer[q],A,!1);else{const K=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,X=x.__webglDepthbuffer[q];i.bindRenderbuffer(i.RENDERBUFFER,X),i.framebufferRenderbuffer(i.FRAMEBUFFER,K,i.RENDERBUFFER,X)}}else{const q=A.texture.mipmaps;if(q&&q.length>0?t.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer===void 0)x.__webglDepthbuffer=i.createRenderbuffer(),Le(x.__webglDepthbuffer,A,!1);else{const K=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,X=x.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,X),i.framebufferRenderbuffer(i.FRAMEBUFFER,K,i.RENDERBUFFER,X)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function gt(A,x,U){const q=n.get(A);x!==void 0&&de(q.__webglFramebuffer,A,A.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),U!==void 0&&He(A)}function Ve(A){const x=A.texture,U=n.get(A),q=n.get(x);A.addEventListener("dispose",R);const K=A.textures,X=A.isWebGLCubeRenderTarget===!0,Se=K.length>1;if(Se||(q.__webglTexture===void 0&&(q.__webglTexture=i.createTexture()),q.__version=x.version,a.memory.textures++),X){U.__webglFramebuffer=[];for(let ie=0;ie<6;ie++)if(x.mipmaps&&x.mipmaps.length>0){U.__webglFramebuffer[ie]=[];for(let xe=0;xe<x.mipmaps.length;xe++)U.__webglFramebuffer[ie][xe]=i.createFramebuffer()}else U.__webglFramebuffer[ie]=i.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){U.__webglFramebuffer=[];for(let ie=0;ie<x.mipmaps.length;ie++)U.__webglFramebuffer[ie]=i.createFramebuffer()}else U.__webglFramebuffer=i.createFramebuffer();if(Se)for(let ie=0,xe=K.length;ie<xe;ie++){const we=n.get(K[ie]);we.__webglTexture===void 0&&(we.__webglTexture=i.createTexture(),a.memory.textures++)}if(A.samples>0&&xt(A)===!1){U.__webglMultisampledFramebuffer=i.createFramebuffer(),U.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,U.__webglMultisampledFramebuffer);for(let ie=0;ie<K.length;ie++){const xe=K[ie];U.__webglColorRenderbuffer[ie]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,U.__webglColorRenderbuffer[ie]);const we=r.convert(xe.format,xe.colorSpace),Q=r.convert(xe.type),ae=T(xe.internalFormat,we,Q,xe.colorSpace,A.isXRRenderTarget===!0),_e=P(A);i.renderbufferStorageMultisample(i.RENDERBUFFER,_e,ae,A.width,A.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ie,i.RENDERBUFFER,U.__webglColorRenderbuffer[ie])}i.bindRenderbuffer(i.RENDERBUFFER,null),A.depthBuffer&&(U.__webglDepthRenderbuffer=i.createRenderbuffer(),Le(U.__webglDepthRenderbuffer,A,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(X){t.bindTexture(i.TEXTURE_CUBE_MAP,q.__webglTexture),Pe(i.TEXTURE_CUBE_MAP,x);for(let ie=0;ie<6;ie++)if(x.mipmaps&&x.mipmaps.length>0)for(let xe=0;xe<x.mipmaps.length;xe++)de(U.__webglFramebuffer[ie][xe],A,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,xe);else de(U.__webglFramebuffer[ie],A,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,0);p(x)&&m(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Se){for(let ie=0,xe=K.length;ie<xe;ie++){const we=K[ie],Q=n.get(we);let ae=i.TEXTURE_2D;(A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(ae=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ae,Q.__webglTexture),Pe(ae,we),de(U.__webglFramebuffer,A,we,i.COLOR_ATTACHMENT0+ie,ae,0),p(we)&&m(ae)}t.unbindTexture()}else{let ie=i.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(ie=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ie,q.__webglTexture),Pe(ie,x),x.mipmaps&&x.mipmaps.length>0)for(let xe=0;xe<x.mipmaps.length;xe++)de(U.__webglFramebuffer[xe],A,x,i.COLOR_ATTACHMENT0,ie,xe);else de(U.__webglFramebuffer,A,x,i.COLOR_ATTACHMENT0,ie,0);p(x)&&m(ie),t.unbindTexture()}A.depthBuffer&&He(A)}function Xe(A){const x=A.textures;for(let U=0,q=x.length;U<q;U++){const K=x[U];if(p(K)){const X=E(A),Se=n.get(K).__webglTexture;t.bindTexture(X,Se),m(X),t.unbindTexture()}}}const Ye=[],Ie=[];function ct(A){if(A.samples>0){if(xt(A)===!1){const x=A.textures,U=A.width,q=A.height;let K=i.COLOR_BUFFER_BIT;const X=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Se=n.get(A),ie=x.length>1;if(ie)for(let we=0;we<x.length;we++)t.bindFramebuffer(i.FRAMEBUFFER,Se.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+we,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,Se.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+we,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,Se.__webglMultisampledFramebuffer);const xe=A.texture.mipmaps;xe&&xe.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Se.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Se.__webglFramebuffer);for(let we=0;we<x.length;we++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(K|=i.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(K|=i.STENCIL_BUFFER_BIT)),ie){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Se.__webglColorRenderbuffer[we]);const Q=n.get(x[we]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Q,0)}i.blitFramebuffer(0,0,U,q,0,0,U,q,K,i.NEAREST),u===!0&&(Ye.length=0,Ie.length=0,Ye.push(i.COLOR_ATTACHMENT0+we),A.depthBuffer&&A.resolveDepthBuffer===!1&&(Ye.push(X),Ie.push(X),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Ie)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Ye))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ie)for(let we=0;we<x.length;we++){t.bindFramebuffer(i.FRAMEBUFFER,Se.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+we,i.RENDERBUFFER,Se.__webglColorRenderbuffer[we]);const Q=n.get(x[we]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,Se.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+we,i.TEXTURE_2D,Q,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Se.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&u){const x=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[x])}}}function P(A){return Math.min(s.maxSamples,A.samples)}function xt(A){const x=n.get(A);return A.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function je(A){const x=a.render.frame;c.get(A)!==x&&(c.set(A,x),A.update())}function it(A,x){const U=A.colorSpace,q=A.format,K=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||U!==Xi&&U!==jn&&(We.getTransfer(U)===$e?(q!==hn||K!==Qt)&&Ae("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ge("WebGLTextures: Unsupported texture color space:",U)),x}function ve(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(l.width=A.naturalWidth||A.width,l.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(l.width=A.displayWidth,l.height=A.displayHeight):(l.width=A.width,l.height=A.height),l}this.allocateTextureUnit=O,this.resetTextureUnits=N,this.setTexture2D=k,this.setTexture2DArray=G,this.setTexture3D=z,this.setTextureCube=j,this.rebindTextures=gt,this.setupRenderTarget=Ve,this.updateRenderTargetMipmap=Xe,this.updateMultisampleRenderTarget=ct,this.setupDepthRenderbuffer=He,this.setupFrameBufferTexture=de,this.useMultisampledRTT=xt,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function J0(i,e){function t(n,s=jn){let r;const a=We.getTransfer(s);if(n===Qt)return i.UNSIGNED_BYTE;if(n===Po)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Do)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Cc)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Pc)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===wc)return i.BYTE;if(n===Rc)return i.SHORT;if(n===xs)return i.UNSIGNED_SHORT;if(n===Co)return i.INT;if(n===yn)return i.UNSIGNED_INT;if(n===xn)return i.FLOAT;if(n===zn)return i.HALF_FLOAT;if(n===Dc)return i.ALPHA;if(n===Lc)return i.RGB;if(n===hn)return i.RGBA;if(n===kn)return i.DEPTH_COMPONENT;if(n===fi)return i.DEPTH_STENCIL;if(n===Ic)return i.RED;if(n===Lo)return i.RED_INTEGER;if(n===Wi)return i.RG;if(n===Io)return i.RG_INTEGER;if(n===Uo)return i.RGBA_INTEGER;if(n===rr||n===ar||n===or||n===lr)if(a===$e)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===rr)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===ar)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===or)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===lr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===rr)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===ar)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===or)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===lr)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Ba||n===za||n===ka||n===Va)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Ba)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===za)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===ka)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Va)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Ha||n===Ga||n===Wa||n===Xa||n===qa||n===Ya||n===ja)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Ha||n===Ga)return a===$e?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Wa)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===Xa)return r.COMPRESSED_R11_EAC;if(n===qa)return r.COMPRESSED_SIGNED_R11_EAC;if(n===Ya)return r.COMPRESSED_RG11_EAC;if(n===ja)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Za||n===Ka||n===$a||n===Ja||n===Qa||n===eo||n===to||n===no||n===io||n===so||n===ro||n===ao||n===oo||n===lo)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Za)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ka)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===$a)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Ja)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Qa)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===eo)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===to)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===no)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===io)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===so)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===ro)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===ao)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===oo)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===lo)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===co||n===uo||n===ho)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===co)return a===$e?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===uo)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===ho)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===fo||n===po||n===mo||n===go)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===fo)return r.COMPRESSED_RED_RGTC1_EXT;if(n===po)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===mo)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===go)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===vs?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const Q0=`
void main() {
