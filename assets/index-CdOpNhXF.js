...
`)+`
`+p);const b=E+m+a,y=E+p+o,A=oc(s,s.VERTEX_SHADER,b),w=oc(s,s.FRAGMENT_SHADER,y);s.attachShader(g,A),s.attachShader(g,w),t.index0AttributeName!==void 0?s.bindAttribLocation(g,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(g,0,"position"),s.linkProgram(g);function R(C){if(i.debug.checkShaderErrors){const O=s.getProgramInfoLog(g)||"",B=s.getShaderInfoLog(A)||"",W=s.getShaderInfoLog(w)||"",H=O.trim(),G=B.trim(),z=W.trim();let K=!0,oe=!0;if(s.getProgramParameter(g,s.LINK_STATUS)===!1)if(K=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,g,A,w);else{const te=cc(s,A,"vertex"),ue=cc(s,w,"fragment");Ve("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(g,s.VALIDATE_STATUS)+`
