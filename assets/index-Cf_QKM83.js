...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Fn,depthTest:!1,depthWrite:!1})}function hm(i,e,t){const n=new Float32Array(hi),s=new P(0,1,0);return new fn({name:"SphericalGaussianBlur",defines:{n:hi,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Ir(),fragmentShader:`
		...
		`,blending:Fn,depthTest:!1,depthWrite:!1})}function kl(){return new fn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ir(),fragmentShader:`
		...
		`,blending:Fn,depthTest:!1,depthWrite:!1})}function Hl(){return new fn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ir(),fragmentShader:`
...
`)}const g0={[yc]:"Linear",[Ec]:"Reinhard",[bc]:"Cineon",[Co]:"ACESFilmic",[Ac]:"AgX",[wc]:"Neutral",[Tc]:"Custom"};function _0(i,e){const t=g0[e];return t===void 0?(Re("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const tr=new P;function x0(){je.getLuminanceCoefficients(tr);const i=tr.x.toFixed(4),e=tr.y.toFixed(4),t=tr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function S0(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function us(i){return i!==""}function $l(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Jl(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const y0=/^[ \t]*#include +<([\w\d./]+)>/gm;function So(i){return i.replace(y0,b0)}const E0=new Map;function b0(i,e){let t=Ue[e];if(t===void 0){const n=E0.get(e);if(n!==void 0)t=Ue[n],Re('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return So(t)}const T0=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Ql(i){return i.replace(T0,A0)}function A0(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function ec(i){let e=`precision ${i.precision} float;
...
`].filter(us).join(`
`)),a=So(a),a=$l(a,t),a=Jl(a,t),o=So(o),o=$l(o,t),o=Jl(o,t),a=Ql(a),o=Ql(o),t.isRawShaderMaterial!==!0&&(S=`#version 300 es
...
`)+`
`+h);const b=S+p+a,E=S+h+o,T=jl(s,s.VERTEX_SHADER,b),w=jl(s,s.FRAGMENT_SHADER,E);s.attachShader(g,T),s.attachShader(g,w),t.index0AttributeName!==void 0?s.bindAttribLocation(g,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(g,0,"position"),s.linkProgram(g);function C(R){if(i.debug.checkShaderErrors){const I=s.getProgramInfoLog(g)||"",O=s.getShaderInfoLog(T)||"",V=s.getShaderInfoLog(w)||"",H=I.trim(),z=O.trim(),B=V.trim();let q=!0,J=!0;if(s.getProgramParameter(g,s.LINK_STATUS)===!1)if(q=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,g,T,w);else{const te=Zl(s,T,"vertex"),ie=Zl(s,w,"fragment");Ye("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(g,s.VALIDATE_STATUS)+`
...
`}),q=M||C*25,J=new Ne(H,B);J.scale.setScalar(q*1.2/C),J.userData.isBlackHoleProxy=!0,z.uDiskScale.value=q*1.2,E.add(J);const te=new hn(1,32,32),ie=new yn({color:0}),Ee=new Ne(te,ie);Ee.scale.setScalar(1),E.add(Ee),E.userData.proxy=J,s.push(J),a.push({points:J,isProcedural:!0,parentName:g.name,uniforms:z,outerRadius:q,starMesh:E})}else{const H=new Zn({size:C*2.7,map:m,transparent:!0,opacity:1,vertexColors:!0,blending:$t,depthWrite:!1,sizeAttenuation:!0}),z=new pi(R,H);h.add(z),a.push({points:z,parentName:g.name,outerRadius:M})}}if(g.hasGasStream){const M=new st,R=new Float32Array(12e3*3),I=new Float32Array(12e3*3);M.setAttribute("position",new mt(R,3)),M.setAttribute("color",new mt(I,3));const O=new Zn({size:1,map:m,transparent:!0,opacity:1,vertexColors:!0,blending:$t,depthTest:!1,depthWrite:!1,sizeAttenuation:!0}),V=new pi(M,O);V.frustumCulled=!1,V.renderOrder=100,M.boundingSphere=new Zi(new P,1e6);const H=new Float32Array(12e3),z=new Float32Array(12e3);for(let q=0;q<12e3;q++)H[q]=Math.random(),z[q]=Math.random();V.userData={tArray:H,seedArray:z,count:12e3};const B=g.gasStreamTarget||p;h.add(V),o.push({points:V,source:g.name,target:B})}if(g.orbit){const v=[],M=g.orbit.radius,R=g.orbit.eccentricity||0,I=ct.degToRad(g.orbit.argumentOfPeriapsis||0),O=ct.degToRad(g.orbit.inclination||0),V=ct.degToRad(g.orbit.longitudeOfAscendingNode||0);for(let B=0;B<=256;B++){const q=B/256*Math.PI*2;let J=q;for(let Ae=0;Ae<3;Ae++)J=J-(J-R*Math.sin(J)-q)/(1-R*Math.cos(J));const te=M*(Math.cos(J)-R),ie=M*Math.sqrt(1-R*R)*Math.sin(J),Ee=new P(te,0,ie);Ee.applyAxisAngle(new P(0,1,0),I),Ee.applyAxisAngle(new P(1,0,0),O),Ee.applyAxisAngle(new P(0,1,0),V),v.push(Ee)}const H=g.type==="planet"?54015:16733440,z=new lr(new st().setFromPoints(v),new Ss({color:H,transparent:!0,opacity:.25}));z.userData={parentName:p},h.add(z),r.push(z)}g.belts&&g.belts.forEach(v=>{const M=v.count||1e3,R=new st,I=new Float32Array(M*3),O=[];for(let z=0;z<M;z++){const B=ct.lerp(v.minRadius,v.maxRadius,Math.random()),q=Math.random()*Math.PI*2,J=(Math.random()-.5)*(B*.05);I[z*3]=Math.cos(q)*B,I[z*3+1]=J,I[z*3+2]=Math.sin(q)*B,O.push({r:B,angle:q,y:J,speed:.005/Math.sqrt(B)*(.8+Math.random()*.4)})}R.setAttribute("position",new mt(I,3));const V=new Zn({color:v.color||8947848,size:T*3.5,transparent:!0,opacity:v.opacity||.5,sizeAttenuation:!0,blending:$t}),H=new pi(R,V);h.add(H),l.push({mesh:H,orbitData:O,parentName:g.name})}),g.planets&&g.planets.forEach(v=>_(v,g.name,h,S+1))};return ru.forEach(g=>{const p=new un;p.position.set(g.position.x,g.position.y,g.position.z),g.stars.forEach(h=>_(h,null,p,0,g.name)),t.add(p)}),i.add(t),n.sort((g,p)=>g.userData.depth-p.userData.depth),{group:t,allSelectable:s,update:(g,p)=>{n.forEach(h=>{const S=h.userData;if(!S.orbit)return;const b=S.parentName?n.find(v=>v.userData.name===S.parentName):null;if(!b)return;S.angle+=(S.orbit.speed||.1)*g*p*.1;const E=S.orbit.radius,T=S.orbit.eccentricity||0;let w=S.angle;if(T>0)for(let v=0;v<4;v++)w=w-(w-T*Math.sin(w)-S.angle)/(1-T*Math.cos(w));const C=E*(Math.cos(w)-T),F=E*Math.sqrt(1-T*T)*Math.sin(w);if(c.set(C,0,F),S.orbit.inclination||S.orbit.argumentOfPeriapsis||S.orbit.longitudeOfAscendingNode){const v=ct.degToRad(S.orbit.argumentOfPeriapsis||0),M=ct.degToRad(S.orbit.inclination||0),R=ct.degToRad(S.orbit.longitudeOfAscendingNode||0);c.applyAxisAngle(new P(0,1,0),v),c.applyAxisAngle(new P(1,0,0),M),c.applyAxisAngle(new P(0,1,0),R)}h.position.addVectors(b.position,c),S.isDistorted&&h.lookAt(b.position)}),r.forEach(h=>{const S=n.find(b=>b.userData.name===h.userData.parentName);S&&h.position.copy(S.position)}),a.forEach(h=>{const S=n.find(b=>b.userData.name===h.parentName);S&&(h.isProcedural?h.uniforms&&(h.uniforms.uTime.value+=p*g,h.uniforms.uCamPos.value.copy(i.userData.camera?.position||new P),h.uniforms.uSingularityPos.value.copy(S.position),S.updateMatrixWorld(!0),c.copy(i.userData.camera.position),S.worldToLocal(c),h.uniforms.uLocalCamPos.value.copy(c)):(h.points.position.copy(S.position),h.points.rotation.y+=.6*g*p))}),o.forEach(h=>{const S=n.find(T=>T.userData.name===h.source),b=n.find(T=>T.userData.name===h.target),E=a.find(T=>T.parentName===h.target);if(S&&b&&E){const T=new P().subVectors(b.position,S.position),w=T.length(),C=T.clone().normalize(),F=new P(0,1,0),v=new P().crossVectors(C,F).normalize();v.length()<.1&&v.set(1,0,0);const M=S.userData.visualScale*(S.userData.distortionAxes?.z||1.8),R=S.position.clone().add(C.clone().multiplyScalar(M*1.1)),I=E.outerRadius||(E.uniforms?E.uniforms.uDiskRadius.value:100),O=b.position.clone().add(v.clone().multiplyScalar(I*.95)),V=O.clone().sub(C.clone().multiplyScalar(w*.6)),H=new nd(R,V,O),{points:z}=h,{tArray:B,seedArray:q,count:J}=z.userData,te=z.geometry.attributes.position,ie=z.geometry.attributes.color,Ee=new ze(16746530),Ae=new ze(16774604);for(let Ve=0;Ve<J;Ve++){B[Ve]=(B[Ve]+.35*p*g*(.85+q[Ve]*.15))%1;const Ge=B[Ve],Y=q[Ve],$=H.getPoint(Ge),de=S.userData.visualScale*.48,we=(.2+Y*1.5)*(1.1-Ge*.75),ge=de*we*Math.sin(Y*20)*Math.cos(Y*40),We=de*we*Math.sin(Y*30)*(1+Ge*3.5),_t=de*we*Math.cos(Y*50);te.setXYZ(Ve,$.x+ge,$.y+We,$.z+_t);const He=Ee.clone().lerp(Ae,Math.pow(Ge,1.3));let Xe=15;Ge>.9&&(Xe*=1-(Ge-.9)*10);const Ze=.82+Math.random()*.48;ie.setXYZ(Ve,He.r*Xe*Ze,He.g*Xe*Ze,He.b*Xe*Ze)}te.needsUpdate=!0,ie.needsUpdate=!0,z.material.size=b.userData.visualScale*3.5}}),r.forEach(h=>{const S=n.find(b=>b.userData.name===h.userData.parentName);S&&h.position.copy(S.position)}),u.forEach(h=>{const S=n.find(b=>b.userData.name===h.parentName);S&&(h.group.position.copy(S.position),h.group.children.forEach(b=>b.material.map.offset.y-=7*g*p))}),l.forEach(h=>{const S=n.find(b=>b.userData.name===h.parentName);if(S){h.mesh.position.copy(S.position);const b=h.mesh.geometry.attributes.position;for(let E=0;E<h.orbitData.length;E++){const T=h.orbitData[E];T.angle+=T.speed*g*p*5,b.setXYZ(E,Math.cos(T.angle)*T.r,T.y,Math.sin(T.angle)*T.r)}b.needsUpdate=!0}})},getStarMeshes:()=>s,setVisible:(g,p,h,S)=>{r.forEach(b=>b.visible=h)}}}const Xt=new qh,St=new Wt(45,window.innerWidth/window.innerHeight,.5,1e9),Tn=new pg({antialias:!0,logarithmicDepthBuffer:!0});Tn.setSize(window.innerWidth,window.innerHeight);Tn.setPixelRatio(Math.min(window.devicePixelRatio,2));document.getElementById("app").appendChild(Tn.domElement);Tn.toneMapping=Co;Tn.toneMappingExposure=.8;St.position.set(0,60,450);St.lookAt(0,0,0);Xt.userData.camera=St;const Fg=document.getElementById("loading-screen"),Og=document.getElementById("loading-bar"),au=document.getElementById("loading-status"),ou={"starmap_8k.jpg":"深空背景","saturn_ring_v3.png":"土星環"},lu=i=>{i.forEach(e=>{e.texture&&(ou[e.texture]=e.nameCH||e.name),e.satellites&&lu(e.satellites)})};lu(su);const Ji=new jc;Ji.onProgress=(i,e,t)=>{const n=e/t*100;Og.style.width=n+"%";const s=i.split("/").pop().split("?")[0],r=ou[s]||s;au.innerText=`正在探索 ${r}`};Ji.onLoad=()=>{setTimeout(()=>{Fg.classList.add("fade-out")},500)};Ji.onError=i=>{console.error("There was an error loading "+i),au.innerText="部分資源讀取失敗，正在嘗試繼續..."};const ya=Pg(Xt,Ji),cu=Dg(Xt);cu.mesh.visible=!1;const Ct=new gg(St,Tn.domElement);Ct.enableDamping=!0;Ct.target.set(0,0,0);const Es=()=>{const i=window.innerWidth,e=window.innerHeight;St.aspect=i/e,St.updateProjectionMatrix(),Tn.setSize(i,e)};window.addEventListener("resize",Es);window.addEventListener("orientationchange",()=>setTimeout(Es,200));Es();Ct.update();Ct.mouseButtons={LEFT:dn.ROTATE,MIDDLE:dn.DOLLY,RIGHT:dn.PAN};Ct.maxDistance=1e6;const Bg=new fd(16777215,.15);Xt.add(Bg);const uu=new Zc(16777215,300,15e3,1.2);uu.position.set(0,0,0);Xt.add(uu);const zg=new cd(16777215,0,.2);Xt.add(zg);let dt=.1;const hu=document.getElementById("speed-display"),ft=Rg(Xt,Ji);ft.setSpeedMultiplier(dt);hu.innerText=`${dt.toFixed(1)}x`;const Jn=Lg(Xt),Qn=Ig(Xt),ei=Ug(Xt),Qt=Ng(Xt,Ji);Qt&&Qt.group&&(Qt.group.rotation.x=ct.degToRad(-63),Qt.group.rotation.z=ct.degToRad(45));let ki=!0,ur=!1,hr=!1,dr=!1,fr=!1,pr=!1,mr=!0,gr=!1,_r=!1,fs=!0,ps=!0,xr=!0;const en=()=>{ft&&(ft.setOrbitsVisibleByType("planet",ki),ft.setOrbitsVisibleByType("star",ki),ft.setOrbitsVisibleByType("dwarf_planet",dr),ft.setOrbitsVisibleByType("dwarf_planet_candidate",fr),ft.setOrbitsVisibleByType("interstellar",pr),ft.setOrbitsVisibleByType("asteroid",gr),ft.setOrbitsVisibleByType("comet",_r),ft.setSatOrbitsVisibleByType("satellite",ur),ft.setSatOrbitsVisibleByType("space_station",hr)),Qt&&Qt.setVisible(mr,ki,fs,ps),Jn&&Jn.setVisible(fs),Qn&&Qn.setVisible(ps),ei&&ei.setVisible(xr)};en();const Ea=new gd,ba=new De;let qe=null;const bs=document.getElementById("info-panel"),kg=document.getElementById("info-title"),Hg=document.getElementById("info-description"),oc=document.getElementById("info-details"),Vg=document.getElementById("close-info"),Gg=document.getElementById("reset-view");let yo=!1,Eo={x:0,y:0},Ar=!1,kn=!1,bo=new P;window.addEventListener("pointerdown",i=>{yo=!0,Eo={x:i.clientX,y:i.clientY}});window.addEventListener("pointerup",i=>{if(!yo)return;yo=!1;const e=Math.abs(i.clientX-Eo.x),t=Math.abs(i.clientY-Eo.y),n=window.innerWidth<=1100?15:5;e>n||t>n||i.pointerType==="mouse"&&i.button!==0&&i.button!==2||Wg(i.clientX,i.clientY,i.target)});function Wg(i,e,t){if(t.closest("#controls")||t.closest("#sub-menu")||t.closest("#info-panel")||t.closest(".search-result-item")||t.tagName==="BUTTON"||t.tagName==="INPUT"||t.tagName==="A"||wr)return;const s=Tn.domElement.getBoundingClientRect();ba.x=(i-s.left)/s.width*2-1,ba.y=-((e-s.top)/s.height)*2+1,Ea.setFromCamera(ba,St);const r=ft.getBodies(),a=[];r.forEach(u=>{a.push(u.mesh),u.satellites.forEach(l=>a.push(l.mesh))}),Qt&&a.push(...Qt.getStarMeshes());const o=Ea.intersectObjects(a,!0);if(o.length>0){let u=null,l=null;for(let c=0;c<o.length;c++){let d=o[c].object;for(;d;){if(d.userData&&d.userData.description){u=d,l=d.userData;break}d=d.parent}if(u)break}l&&Cr(u)}else if(!bs.classList.contains("hidden"))du();else{qe=null;const u=new P;St.getWorldDirection(u).negate();const l=new Un().setFromNormalAndCoplanarPoint(u,Ct.target),c=new P;Ea.ray.intersectPlane(l,c),c&&Ct.target.copy(c)}}Ct.addEventListener("start",()=>{Ar=!0,kn=!1});window.addEventListener("wheel",()=>{kn=!1},{passive:!0});Ct.addEventListener("end",()=>{Ar=!1});window.addEventListener("contextmenu",i=>{i.pointerType==="mouse"&&!document.getElementById("controls").contains(i.target)&&!document.getElementById("search-results").contains(i.target)&&i.preventDefault()});function du(){bs.classList.add("hidden")}Vg.addEventListener("click",()=>{du()});Gg.addEventListener("click",i=>{i.stopPropagation(),qe&&(kn=!0)});function Xg(i){kg.innerText=`${i.name}   ${i.nameCH||""}`,Hg.innerText=i.description||"暫無介紹。",oc.innerHTML="",["類型","質量","體積","直徑","史瓦西半徑","光度","視星等","絕對星等","核心溫度","表面溫度","光譜類型","狀態","位置"].forEach(t=>{const n=i.details&&i.details[t]?i.details[t]:"N/A",s=document.createElement("div");s.className="info-detail-item",s.innerHTML=`
      <span class="info-detail-label">${t}</span>
      <span class="info-detail-value">${n}</span>
    `,oc.appendChild(s)}),bs.classList.remove("hidden")}let fu=null,pu=null;const Nr=i=>{An();const e=()=>{i?dt<.1?dt=.1:dt<.5?dt=.5:dt+=.5:dt>.5?dt-=.5:dt>.1?dt=.1:dt=0,gu()};e(),fu=setTimeout(()=>{pu=setInterval(e,100)},2e3)},An=()=>{clearTimeout(fu),clearInterval(pu)},Qi=document.getElementById("slow"),es=document.getElementById("fast");Qi.addEventListener("mousedown",()=>Nr(!1));es.addEventListener("mousedown",()=>Nr(!0));Qi.addEventListener("mouseup",An);es.addEventListener("mouseup",An);window.addEventListener("mouseup",An);Qi.addEventListener("mouseleave",An);es.addEventListener("mouseleave",An);Qi.addEventListener("touchstart",i=>{i.preventDefault(),Nr(!1)});es.addEventListener("touchstart",i=>{i.preventDefault(),Nr(!0)});Qi.addEventListener("touchend",An);es.addEventListener("touchend",An);Qi.addEventListener("touchcancel",An);es.addEventListener("touchcancel",An);let ms=!1,Ta=.1;const qg=document.getElementById("pause"),To=document.getElementById("pause-icon"),mu='<svg viewBox="0 0 24 24" width="22" height="22" stroke="currentColor" stroke-width="3" fill="none"><path d="M9 18V8M15 18V8"/></svg>',Yg='<svg viewBox="0 0 24 24" width="22" height="22" stroke="currentColor" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round"><path d="M5 3l14 9-14 9V3z"/></svg>';qg.addEventListener("click",()=>{ms?(dt=Ta===0?.1:Ta,ms=!1,To.innerHTML=mu):(Ta=dt,dt=0,ms=!0,To.innerHTML=Yg),gu()});function gu(){ft.setSpeedMultiplier(dt),hu.innerText=`${dt.toFixed(1)}x`,dt>0&&ms&&(ms=!1,To.innerHTML=mu)}const Xo=document.getElementById("menu-toggle"),gs=document.getElementById("sub-menu"),vr=document.getElementById("mode-artistic"),Mr=document.getElementById("mode-real");document.getElementById("toggle-orbits");const _u=i=>{i.stopPropagation(),gs.classList.toggle("hidden")};Xo.addEventListener("click",_u);Xo.addEventListener("touchstart",i=>{i.preventDefault(),_u(i)},{passive:!1});window.addEventListener("click",i=>{!gs.classList.contains("hidden")&&!gs.contains(i.target)&&i.target!==Xo&&gs.classList.add("hidden")});const lc=document.getElementById("toggle-manmade-orbit"),cc=document.getElementById("toggle-planet-orbit"),uc=document.getElementById("toggle-sat-orbit"),hc=document.getElementById("toggle-dwarf-orbit"),dc=document.getElementById("toggle-candidate-orbit"),fc=document.getElementById("toggle-interstellar-orbit"),pc=document.getElementById("toggle-asteroid-orbit"),mc=document.getElementById("toggle-comet-orbit"),gc=document.getElementById("toggle-belt"),_c=document.getElementById("toggle-kuiper"),xc=document.getElementById("toggle-oort"),vc=document.getElementById("toggle-star-orbit");lc.addEventListener("click",()=>{hr=!hr,lc.classList.toggle("active",hr),en()});cc.addEventListener("click",()=>{ki=!ki,cc.classList.toggle("active",ki),en()});uc.addEventListener("click",()=>{ur=!ur,uc.classList.toggle("active",ur),en()});hc.addEventListener("click",()=>{dr=!dr,hc.classList.toggle("active",dr),en()});dc.addEventListener("click",()=>{fr=!fr,dc.classList.toggle("active",fr),en()});fc.addEventListener("click",()=>{pr=!pr,fc.classList.toggle("active",pr),en()});vc.addEventListener("click",()=>{mr=!mr,vc.classList.toggle("active",mr),en()});pc.addEventListener("click",()=>{gr=!gr,pc.classList.toggle("active",gr),en()});gc.addEventListener("click",()=>{fs=!fs,gc.classList.toggle("active",fs),en()});_c.addEventListener("click",()=>{ps=!ps,_c.classList.toggle("active",ps),en()});mc.addEventListener("click",()=>{_r=!_r,mc.classList.toggle("active",_r),en()});xc.addEventListener("click",()=>{xr=!xr,xc.classList.toggle("active",xr),en()});vr.addEventListener("click",()=>{vr.classList.contains("active")||(vr.classList.add("active"),Mr.classList.remove("active"),ft.setViewMode(!1),Jn&&Jn.setViewMode(!1),Qn&&Qn.setViewMode(!1),ei&&ei.setViewMode(!1),qe?kn=!0:(St.position.set(0,150,250),St.lookAt(0,0,0)))});Mr.addEventListener("click",()=>{Mr.classList.contains("active")||(Mr.classList.add("active"),vr.classList.remove("active"),ft.setViewMode(!0),Jn&&Jn.setViewMode(!0),Qn&&Qn.setViewMode(!0),ei&&ei.setViewMode(!0),qe&&(kn=!0))});const Hi=document.getElementById("planet-search"),Bt=document.getElementById("search-results"),Ts=document.getElementById("clear-search"),Ao=document.getElementById("reset-to-sun");let wr=!1;const jg={planet:"行星",star:"恆星",dwarf_planet:"矮行星",dwarf_planet_candidate:"候選/TNO",asteroid:"小行星",interstellar:"星際天體",satellite:"衛星",comet:"彗星",space_station:"人造物體"};function Cr(i,e=!1){qe=i;const t=i.userData;kn=!0,Xg(t),qe.updateMatrixWorld(!0),qe.getWorldPosition(bo),e?(Hi.blur(),setTimeout(()=>{qe===i&&(kn=!0,Es())},450)):(!qe||qe!==i)&&(Es(),Bt.classList.add("hidden"),Bt.innerHTML="",Hi.value="",Ts.classList.add("hidden"))}Hi.addEventListener("input",()=>{const i=Hi.value.trim().toLowerCase();if(Ts.classList.toggle("hidden",i===""),i.length<1){Bt.innerHTML="",Bt.classList.add("hidden");return}const e=ft.getBodies(),t=[];e.forEach(s=>{t.push({mesh:s.mesh,data:s.data,type:s.data.type}),s.satellites.forEach(r=>{t.push({mesh:r.mesh,data:r.data,type:"satellite"})})}),Qt&&Qt.getStarMeshes().forEach(r=>{t.push({mesh:r,data:r.userData,type:"star"})});const n=t.filter(s=>s.data.name.toLowerCase().includes(i)||s.data.nameCH&&s.data.nameCH.includes(i));n.length>0?(Bt.innerHTML=n.map(s=>`
    ...
    `).join(""),Bt.classList.remove("hidden"),Bt.querySelectorAll(".search-result-item").forEach(s=>{const r=a=>{a.stopPropagation(),a.preventDefault(),wr=!0;const o=s.getAttribute("data-id"),u=t.find(l=>l.data.name===o);u&&Cr(u.mesh,!0),setTimeout(()=>{Bt.classList.add("hidden"),Bt.innerHTML="",Hi.value="",Ts.classList.add("hidden"),wr=!1},800)};s.addEventListener("mousedown",r),s.addEventListener("touchstart",r,{passive:!1})})):(Bt.innerHTML='<div class="search-result-item">無符合天體</div>',Bt.classList.remove("hidden"))});Ts.addEventListener("click",i=>{i.stopPropagation(),Hi.value="",Ts.classList.add("hidden"),Bt.innerHTML="",Bt.classList.add("hidden")});const mi=document.getElementById("system-menu"),Kg=()=>{const i=[{id:"solar",name:"Sun",nameCH:"太陽系",distance:0,status:"當前所在",icon:"textures/sun.jpg"},...ru.map(t=>({id:t.name,name:t.name,nameCH:t.nameCH,distance:t.distanceFromSun,status:`距離 ${(t.distanceFromSun/63241).toFixed(2)} 光年`,icon:t.menuIcon||"textures/star_placeholder.png"}))];i.sort((t,n)=>t.distance-n.distance);const e=i.map(t=>{let n=`<img src="${t.icon}" alt="${t.name}">`;if(t.icon.startsWith("gradient:")){const s=t.icon.split(":")[1],r=s==="scorpius"?"#00ccff":"#88ccff";n=`<div style="background: radial-gradient(circle, ${r}, #000); display: flex; align-items: center; justify-content: center; width:100%; height:100%;">
                    <div style="${s==="scorpius"?"width: 80%; height: 80%;":"width: 70%; height: 30%; transform: rotate(-20deg);"} border: 1px solid ${r}; border-radius: 50%; box-shadow: 0 0 10px ${r};"></div>
                  </div>`}return`
    ...
    `}).join("");mi.innerHTML=`<div class="menu-label">選擇恆星系</div>${e}`};Kg();mi.addEventListener("click",i=>{const e=i.target.closest(".system-menu-item");if(!e)return;const t=e.getAttribute("data-id");if(mi.querySelectorAll(".system-menu-item").forEach(n=>n.classList.remove("active")),e.classList.add("active"),t==="solar"){const n=ft.getBodies().find(s=>s.data.name==="Sun");n&&Cr(n.mesh)}else{const n=Qt.getStarMeshes();let s;t==="Castor"?s=n.find(r=>r.userData.name==="Castor A1 (Aa)"):t==="Scorpius X-1"?s=n.find(r=>r.userData.name==="Scorpius X-1 (Neutron Star)"):t==="Beta Lyrae"?s=n.find(r=>r.userData.name==="Beta Lyrae B (Accretor)"):s=n.find(r=>r.userData.parentSystem===t||r.userData.name.includes(t)),s&&Cr(s)}mi.classList.add("hidden")});Ao.addEventListener("click",i=>{i.stopPropagation(),mi.classList.toggle("hidden"),gs.classList.add("hidden"),Bt.classList.add("hidden")});window.addEventListener("mousedown",i=>{document.getElementById("search-container").contains(i.target)||Bt.classList.add("hidden"),!mi.contains(i.target)&&i.target!==Ao&&!Ao.contains(i.target)&&mi.classList.add("hidden")});window.addEventListener("resize",()=>{St.aspect=window.innerWidth/window.innerHeight,St.updateProjectionMatrix(),Tn.setSize(window.innerWidth,window.innerHeight)});const Zg=["controls","sub-menu","info-panel","system-menu"];Zg.forEach(i=>{const e=document.getElementById(i);if(!e)return;const t=n=>n.stopPropagation();["mousedown","mouseup","click","dblclick","wheel","touchstart","touchend","touchmove"].forEach(n=>{e.addEventListener(n,t)})});const $g=new md,In=new P,ci=new P,Fi=new P,Aa=new P,Mc=new P;function xu(){requestAnimationFrame(xu);const i=$g.getDelta(),e=Math.min(i,.1);Xt.userData.camera=St,ft&&ft.update(e),Jn&&Jn.update(dt,e),Qn&&Qn.update(dt,e),ei&&ei.update(dt,e),Qt&&Qt.update(dt,e),ya&&ya.update&&ya.update(St.position,e);const t=bs&&!bs.classList.contains("hidden");if(t?(Ct.enablePan=!1,Ct.mouseButtons.RIGHT=dn.ROTATE):(Ct.enablePan=!0,Ct.mouseButtons.RIGHT=dn.PAN),qe){if(qe.updateMatrixWorld(!0),qe.getWorldPosition(In),kn){const s=ft.isRealScale(),r=qe.userData.isInterstellar;let a=s&&qe.userData.realScaleRadius||qe.userData.radius;r&&(a=qe.userData.maxVisualRadius||qe.userData.visualScale,qe.userData.hasAccretionDisk&&qe.userData.diskRadius&&(a=Math.max(a,qe.userData.diskRadius*.45)));const o=r?45:window.innerWidth<=480?18:window.innerWidth<=1100?12:6,u=a*o,l=St.position.distanceTo(In),c=ct.lerp(l,u,.05);ci.subVectors(St.position,In).normalize(),Fi.copy(In).add(ci.multiplyScalar(c)),St.position.copy(Fi),Math.abs(l-u)<a*.1&&(kn=!1)}if(t){if(ci.subVectors(In,bo),St.position.add(ci),Fi.copy(In),window.innerWidth<=1100){const s=window.innerWidth<=480,r=window.innerWidth>window.innerHeight;ci.subVectors(St.position,In).normalize(),Aa.set(0,1,0).cross(ci).normalize(),Mc.crossVectors(ci,Aa).normalize();const a=ft.isRealScale(),o=qe.userData.isInterstellar;let u=a&&qe.userData.realScaleRadius||qe.userData.radius;o&&(u=qe.userData.maxVisualRadius||qe.userData.visualScale,qe.userData.hasAccretionDisk&&qe.userData.diskRadius&&(u=Math.max(u,qe.userData.diskRadius*.5)));const c=u*(o?60:s?25:15);if(r)Fi.add(Aa.multiplyScalar(c*.18));else{const d=s?-.12:-.08;Fi.add(Mc.multiplyScalar(c*d))}}Ct.target.copy(Fi)}else!Ar&&qe&&Ct.target.lerp(In,.1);bo.copy(In)}const n=Ct.target.clone();Ct.update(),!t&&Ar&&Ct.target.distanceTo(n)>.01&&(qe=null),Tn.render(Xt,St)}xu();window.scene=Xt;window.ship=cu;window.solarSystem=ft;
