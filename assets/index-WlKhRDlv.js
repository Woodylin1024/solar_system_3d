...
`)}const qp={[dl]:"Linear",[fl]:"Reinhard",[pl]:"Cineon",[Pa]:"ACESFilmic",[gl]:"AgX",[_l]:"Neutral",[ml]:"Custom"};function jp(i,e){const t=qp[e];return t===void 0?(Ae("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const ys=new U;function Zp(){He.getLuminanceCoefficients(ys);const i=ys.x.toFixed(4),e=ys.y.toFixed(4),t=ys.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`].filter(Fi).join(`
`)),a=Ta(a),a=el(a,t),a=tl(a,t),o=Ta(o),o=el(o,t),o=tl(o,t),a=nl(a),o=nl(o),t.isRawShaderMaterial!==!0&&(y=`#version 300 es
